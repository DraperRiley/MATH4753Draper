#' @title a function which uses the bootstrap method to generate a p-value
#'
#' @param x a vector of data
#' @param conf.level the desired confidence level
#' @param iter the number of iterations
#' @param mu0 the value of mu
#' @param test the areas to generate
#'
#' @return a list of values
#' @export
#'
#' @examples
#' \dontrun{x=rnorm(...);bootpval(x)}
